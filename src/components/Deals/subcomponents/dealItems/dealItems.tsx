...
const DealItems = ({ menuItem }: { menuItem: menuItem }) => {
  ...
  return (
    <div className="mx-6 flex flex-col text-xl rounded-lg shadow-md bg-white h-[400px] w-fit cursor-pointer hover:shadow-2xl border-2 border-gray-200   duration-500">
      <Image
        src={image}
        alt={""}
        width={120}
